...
- [x] 01-01-PLAN.md — Tracer: Transaction-Pooler Postgres connection + public health-check Edge Function, deployed and verified (SC-1)

**Wave 2** *(blocked on Wave 1 completion)*

- [x] 01-02-PLAN.md — Migrations (extensions) + CI smoke test reusing the same production-shape connection (SC-2, SC-3)

**Wave 3** *(blocked on Wave 2 completion)*

- [x] 01-03-PLAN.md — Vault secrets + Cron/Queue migration: pg_cron scheduled trigger and the sync_work queue (SC-4, trigger+queue halves)
